        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <form action="/xero/invoices" method="GET">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Invoices</small></label>
                            <input value="" name="invoice_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Xero Invoices</button>
                    </form>
                    <form action="/woocommerce/orders" method="GET">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Orders</small></label>
                            <input value="" name="contact_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Woocommerce Orders</button>
                    </form>
                    <form action="/woocommerce/products" method="GET">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Products</small></label>
                            <input value="" name="contact_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Woocommerce Products</button>
                    </form>
                    <form action="/woocommerce/create_order" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Orders</small></label>
                            <input value="" name="contact_id"
                        ...
                        <button class="btn btn-primary">create simple Woocommerce Order</button>
                    </form>
                    <form action="/woocommerce/create_product" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Products</small></label>
                            <input value="" name="contact_id"
                        ...
                        <button class="btn btn-primary">create simple Woocommerce Product</button>
                    </form>
                    <form action="/xero/contacts" method="GET">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Contacts</small></label>
                            <input value="" name="contact_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Xero Contacts</button>
                    </form>
                    <form action="/xero/contactsByName" method="GET">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Contacts name</small></label>
                            <input value="" name="contact_name"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Xero Contacts By Name</button>
                    </form>
                    <form action="/create-board" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Board</small></label>
                            <input value="board name" name="board_name"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>
                    ...
                    <form action="/delete-board" method="POST">
                        ...
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Board</small></label>
                            <input value="" name="board_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Delete Board</button>
                    </form>
                    <form action="/monday/search-item" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Items</small></label>
                            <input value="" name="board_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">/monday/search-item</button>
                    </form>
                    <form action="/get-board" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Board</small></label>
                            <input value="" name="board_id"
                        ...
                        <button class="btn btn-primary">Get Board</button>
                    </form>
                    <form action="/update-board" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Board</small></label>
                            <input value="" name="boardId" class="form-control form-control-lg form-control-title"
                                type="text" />
                        </div>

                        <button class="btn btn-primary">Update Board</button>
                    </form>
                    <form action="/get-items" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Item</small></label>
                            <input value="board_id" name="board_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                            <input value="item_id" name="item_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                            <input value="column_id" name="column_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Get Board Items</button>
                    </form>

                    <form action="/update-items" method="POST">
                        @csrf
                        <div class="form-group">
                            <label class="text-muted mb-1"><small>Item</small></label>
                            <input value="board_id" name="board_id"
                            ...
                            <input value="column_id" name="column_id"
                                class="form-control form-control-lg form-control-title" type="text" />
                            <input value="value to update" name="valueToUpdate"
                                class="form-control form-control-lg form-control-title" type="text" />
                        </div>

                        <button class="btn btn-primary">Update Board Items</button>
                    </form>
